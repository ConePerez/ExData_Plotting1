...
## 7.- Set the global parameter to 4 plots per device.
## 8.- Create the first scatter plot
## 8.1.- Create the second scatter plot
## 8.2.- Create the third scatter plot
## 8.3.- Create the fourth scatter plot
